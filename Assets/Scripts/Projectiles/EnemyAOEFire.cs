...
public class EnemyAOEFire : MonoBehaviour
{
    public int damageOverTime = 1;
    private float timerRate = 0.5f;
    public Vector2 boxSize = new Vector2(5f, 2f); // Set the size of the box
    ...
    {
        // Use Physics2D.OverlapBoxAll instead of Physics2D.OverlapCircleAll
